...
#ifndef MOUSEPHONEIOS_SWIFT_H
#define MOUSEPHONEIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MousePhoneiOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC13MousePhoneiOS28MultipeerControllerTransport")
@interface MultipeerControllerTransport : NSObject
...
@class MCPeerID;
@class NSString;
@interface MultipeerControllerTransport (SWIFT_EXTENSION(MousePhoneiOS)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MultipeerControllerTransport (SWIFT_EXTENSION(MousePhoneiOS)) <MCSessionDelegate>
...
@class UITouch;
@class UIEvent;
SWIFT_CLASS("_TtC13MousePhoneiOS14TrackpadUIView")
...
SWIFT_CLASS("_TtC13MousePhoneiOS20VolumeButtonObserver")
@interface VolumeButtonObserver : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
