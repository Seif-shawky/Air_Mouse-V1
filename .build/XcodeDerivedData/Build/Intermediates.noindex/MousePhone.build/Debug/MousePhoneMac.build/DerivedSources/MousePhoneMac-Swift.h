...
#ifndef MOUSEPHONEMAC_SWIFT_H
#define MOUSEPHONEMAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MousePhoneMac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC13MousePhoneMac26MultipeerReceiverTransport")
@interface MultipeerReceiverTransport : NSObject
...
@class NSData;
@class MCSession;
@interface MultipeerReceiverTransport (SWIFT_EXTENSION(MousePhoneMac)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MultipeerReceiverTransport (SWIFT_EXTENSION(MousePhoneMac)) <MCSessionDelegate>
